...
instance Point Point3d where
  ...
  cmp e1 e2 x = if (sel (x-1) e2) > (sel (x-1) e1) then 1  else 0
...
-- construeix un kd2ntree a partir d'una llista de parells [(punt, llista de coordenades)]
...
-- Excercici 5
-- retorna tots els punts del arbre
